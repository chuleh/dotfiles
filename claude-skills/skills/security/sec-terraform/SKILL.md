...
- Containers (ECS/EKS/GKE/AKS): see `sec-kubernetes` and `sec-docker` skills for runtime concerns; Terraform side ensures private clusters, encrypted etcd, audit logging, restricted control-plane access.
